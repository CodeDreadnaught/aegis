...
export const importDefinitions = {
  equipment: {
    ...
    fields: [
      ...
      field("torqueNm", "Torque (Nm)", false, ["torque_nm", "torqueNM"]),
      ...
      field("pressureBar", "Pressure (bar)", false, ["pressure_bar", "pressureBAR"]),
      field("vibrationMmS", "Vibration (mm/s)", false, ["vibration_mm_s", "vibrationMms", "vibrationMmS"]),
      field("flowRateBpd", "Flow rate (bpd)", false, ["flow_rate_bpd", "flowRateBPD"]),
      field("operatingHours", "Operating hours", false, ["operating_hours"]),
    ],
  },
  operationalReadings: {
    description:
      "Import telemetry from a sensor export. Each row must identify its equipment with equipmentId or assetTag.",
