...
export default function Loading() {
  return (
    <div aria-label="Loading equipment" className="grid gap-4">
      ...
      <Panel className="p-3">
        <div className="grid gap-2 lg:grid-cols-[minmax(18rem,1fr)_14rem_14rem_auto]">
      ...
      <Panel className="min-h-[30rem] p-0">
        ...
        <div className="border-t border-zinc-100 px-4 py-3">
          <Skeleton className="mx-auto h-9 w-64 rounded-full sm:ml-auto sm:mr-0" />
        </div>
      </Panel>
